...
const SignUp = () => {
  ...
  return (
    <div>
      {userdata.token && isUser && (
        <Navigate to={"/"} replace={true}></Navigate>
      )}
      {userdata.token && isAdmin && (
        <Navigate to={"/adminpanel"} replace={true}></Navigate>
      )}
      {isSelected && (
        <div className="">
            ...
            <div class="container pt-5 pb-4">
              <div class="signup row d-flex justify-content-center align-items-center ">
                <div class="col-lg-12 col-xl-11">
                  <div
                    class="loginsignupbox card text-black m-auto"
                          ...
                          <form class="mx-1 mx-md-4" onSubmit={handleSubmit}>
                            <div class=" flex-row align-items-center mb-4 ">
                              ...
                              <span className="text-danger">
                                {" "}
                                {Errorname ? <p>name is required*</p> : ""}
                              </span>
                            </div>
                            ...
                            <div class="  align-items-center mb-4">
                              ...
                              <span className="text-danger">
                                {Errorpassword ? (
                                  <p>password must be greater than 7 digits</p>
                                ) : (
                                  ""
                                )}
                              </span>
